...
;;
;; The resulting account object should procefss a request only if it is accompanied by
;; the password with which the account was created, and should otherwise return a 
;; complaint:
;;
